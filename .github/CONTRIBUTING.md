...
* Go to <https://github.com/iamnewton/osx-theme/pulls> and open a new pull request with your changes and fill out the template with the appropriate information.
